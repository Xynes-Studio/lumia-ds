...
class MockImageNode extends ParagraphNode {
    static getType() { return 'image-block'; }
    static clone(node: MockImageNode) { return new MockImageNode(); }
    static importJSON() { return new MockImageNode(); }
    exportJSON() { return { type: 'image-block', version: 1 } as any; }
    constructor() {
        super();
...
describe('useBlockOutline', () => {
    it('should return initial empty list', () => {
        const { result } = renderHook(() => useBlockOutline(), { wrapper: Wrapper });
